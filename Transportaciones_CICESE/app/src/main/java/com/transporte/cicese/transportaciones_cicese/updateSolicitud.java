...
public class updateSolicitud extends AppCompatActivity {
    ...
    LinearLayout servicioLayout, servicioForm, formContainer;
    ...
    * c=chofer*/
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        servicioLayout              =(LinearLayout) findViewById(R.id.servicioLayout);
        servicioForm                =(LinearLayout) findViewById(R.id.servicioForm);
    ...
    public class SendUpdateData extends AsyncTask<String, Void, ArrayList> {
        ...
        protected void onPostExecute(ArrayList result) {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                Toast.makeText(getApplicationContext(), "Error al actualizar solcitud", Toast.LENGTH_SHORT).show();
            }
        }
    }
        ...
        protected void onPostExecute(ArrayList responseResult) {
            ...
            if (responseCode==HttpsURLConnection.HTTP_OK) {
                ...
                try {
                    ...
                    solicitudesArray[0] = "Selecciona la solicitud que deseas modificar";
                    ArrayList index = new ArrayList();
